...
export default function Home() {
  ...
  // my delpoyed contract.sol(0xd9145CCE52D386f254917e481eB44e9943F39138)
  // 0x690f5C9A81810906DfB603c9BBd743fc475262Bd
 // another deployed 0xD160f41c157ab03d4eA30bd9030546F61eaeF225
  var ContractABI = [
    {
     "inputs": [
      {
      ...
      {data['nfts']?.map(user => (
        <Col gap="5">
                    ...
                    <Card css={{ mw: "230px" }}>
                      ...
                      <Card.Body css={{ py: "$10" }}>
                      <img src= {"https://ipfs.io/ipfs/" + user.file_url.slice(21)} alt='me' width='200' height='200'/>
                      <Spacer y={0.5} />
                      <Row>
                      <Col>
                      <Text>Max Loan: </Text>
